...
class PageviewTest extends UnitTestCase {
  ...
  public function testBasicSettingCommands() {
    ...
    $this->assertEquals(['send', 'pageview'], $command->getSettingCommand());
  }
  ...
  public function testWithFieldsObjectSettingCommmands() {
    ...
    $this->assertEquals(['send', 'pageview', ['field1' => 'value1']], $command->getSettingCommand());
  }
  ...
  public function testWithTrackerNameSettingCommands() {
    ...
    $this->assertEquals(['tracker.send', 'pageview'], $command->getSettingCommand());
  }
