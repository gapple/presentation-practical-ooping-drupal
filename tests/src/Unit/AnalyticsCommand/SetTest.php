...
class SetTest extends UnitTestCase {
  ...
  public function testBasicSettingCommands() {
    ...
    $this->assertEquals(['set', 'key', 'value'], $command->getSettingCommand());
  }
  ...
  public function testWithFieldsObjectSettingCommmands() {
    ...
    $this->assertEquals(['set', 'key', 'value', ['field1' => 'value1']], $command->getSettingCommand());
  }
  ...
  public function testWithTrackerNameSettingCommands() {
    ...
    $this->assertEquals(['tracker.set', 'key', 'value'], $command->getSettingCommand());
  }
